...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('NEW', 'PREPARING', 'READY_FOR_PICKUP_DELIVERY', 'COMPLETED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "RestaurantManager_userId_key" ON "RestaurantManager"("userId");
