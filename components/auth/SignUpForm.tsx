        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
           <div className="grid grid-cols-1 gap-3 mb-4">
            ...
            >
              ...
              <span className="text-base">{t("signUp.signUpWithGoogle", "Sign up with Google")}</span>
            </Button>
          </div>
          ...
          <Button
            type="submit"
            className="w-full my-4 rounded-md bg-primary py-3 font-medium text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 text-base h-12 cursor-pointer"
            disabled={registerCustomer.isPending || success}
          >
